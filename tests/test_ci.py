...
def test_bigger_script():
  ...
  rho_low = [-.24081, -.040511, .055321, .22091]
  rho_up = [.74934, .63791, .53273, .4299]
  co_rho_low = [-.40689, .1645, .15547, .045263]
  co_rho_up = [1.1666, .93126, .86293, .70085]
  
  check_noisy_edm_result(res1, rho_low, rho_up, co_rho_low, co_rho_up)
  
  rho_low = [-.15045, .25476, .53274, .72057]
  rho_up = [.83649, .78668, .83097, .90064]
  co_rho_low = [-.38777, .062654, .32211, .39681]
  co_rho_up = [1.0946, .97872, .7964, .67552]
